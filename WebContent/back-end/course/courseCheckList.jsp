...
<%
	...
	List<CourseVO> list = courseService.getForManage();
...
<body>
	<div class="menu">
		<!-- 卡片內容上方留白的起始標籤 -->
		<h1>
			課程管理<span class="include-page"><%@ include file="page1.file"%></span>
		</h1>
	</div>
	<!-- 卡片內容上方留白的結束標籤 -->
					...
					<c:forEach var="CourseVO" items="${list}" begin="<%=pageIndex%>"
						...
						<tr class="row100 body">
							...
							<td class="cell100 column2"><a
								href="CourseServlet?course_id=${CourseVO.course_id}&action=getOne_ForBackEnd">${status[CourseVO.course_status]}</a></td>
						</tr>
