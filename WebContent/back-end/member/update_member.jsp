...
<!-- 		CROSSORIGIN="ANONYMOUS"></SCRIPT> -->
	...
	<FORM METHOD="post" ACTION="member.do" name="upateform" id="upateform"
		...
		<table>
			...
			<tr>
				<td>會員暱稱:</td>
				<td><input type="TEXT" name="nickname" size="45" id=nickname
					value="<%=membervo.getNickname()%>" /></td>
			</tr>
			...
			<tr>
				<td>點數餘額:</td>
				<td><input type="TEXT" name="balance" size="45" id=balance
					value="<%=membervo.getBalance()%>" /></td>
			</tr>
			<tr>
				<td>信用卡號:</td>
				<td><input type="TEXT" name="member_creditcard" size="45"
					id=member_creditcard value="<%=membervo.getMember_creditcard()%>" /></td>
			</tr>
			<tr>
				<td>會員類型:</td>
				<td><input type="radio" name="member_status" value=0 checked="<%=(membervo.getMember_status()==0)? "true": "false"%>">普通會員<br>
					<input type="radio" name="member_status" value=1 checked="<%=(membervo.getMember_status()==1)? "true": "false"%>">廚師<br>
					<input type="radio" name="member_status" value=2 checked="<%=(membervo.getMember_status()==2)? "true": "false"%>">凍結<br>
				</td>
			</tr>

			<tr>
				<td>會員狀態:</td>
				<td><input type="radio" name="validation" value=0 checked="<%=(membervo.getValidation()==0)? "true": "false"%>">未驗證<br>
					<input type="radio" name="validation" value=1 checked="<%=(membervo.getValidation()==1)? "true": "false"%>"> 已驗證<br>
				</td>
			</tr>
			...
			<tr>
				<td>廚師證照:</td>
				<!-- 按鈕 -->
				<td><input type="file" id="imgView1" name="license" size="45"
			...
			<tr>
				<td>證照審核狀態</td>
				<td><input type="radio" name="chiefapply_status" value=0 checked="<%=(membervo.getChiefapply_status()==0)? "true": "false"%>">
					無須審核<br> <input type="radio" name="chiefapply_status" value=1 checked="<%=(membervo.getChiefapply_status()==1)? "true": "false"%>">
					審核中<br> <input type="radio" name="chiefapply_status" value=2 checked="<%=(membervo.getChiefapply_status()==2)? "true": "false"%>">
					審核通過<br></td>
			</tr>
		...
		<br> <input type="hidden" name="action" value="update"> <input
		 ...
		 <input
			type="submit" value="送出修改" id="send" name="send">
