				...
				<div class="menu-group">
					<a class="menu-group-a"
						...
						href="<%=request.getContextPath() + "/back-end/member/memberPage.jsp?pageType=memberAllList.jsp"%>"><span>會員列表
						 ...
						 <a class="menu-group-a"
						href="<%=request.getContextPath() + "/back-end/member/memberPage.jsp?pageType=memberAllListChiefapplyStatus.jsp"%>"><span>證照審核</span></a>
					<a class="menu-group-a"
						href="<%=request.getContextPath() + "/back-end/member/memberPage.jsp?pageType=memberAllListValidation.jsp"%>"><span>會員驗證
