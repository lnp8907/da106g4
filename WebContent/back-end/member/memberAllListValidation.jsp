...
List<MemberVO> list = memberService.getValidation();
					...
					<c:forEach var="MemberVO" items="${list}" begin="<%=pageIndex%>"
						...
						<tr class="row100 body"  style="${(oldMem_id==MemberVO.member_id)?'background-color: aliceblue;':''}">
							...
							<td class="cell100 column4"><a                                    
								href="member.do?member_id=${MemberVO.member_id}&action=getOneMemberValidation&whichPage=<%=whichPage%>"><button
						...
						<div class="modal-content" >
							...
							<div class="modal-body">
								<!-- =========================================以下為原listOneEmp.jsp的內容========================================== -->
 								<jsp:include page="listOneValidation.jsp" /> 
