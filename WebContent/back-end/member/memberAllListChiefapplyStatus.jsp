...
List<MemberVO> list = memberService.getChiefapplyStatus();
...
// 	MyStaffService myStaffService = new MyStaffService();
	...
	pageContext.setAttribute("CHIEFAPPLY_STATUS",new String[] {"正式會員","審核中","審核通過"});	
			...
			<table class="table">
				<thead>
					<tr class="row100 head" >
						...
						<th class="cell100 column4">證照</th>			
				...
				<tbody>
					<c:forEach var="MemberVO" items="${list}" begin="<%=pageIndex%>"
						...
						<tr class="row100 body"  style="${(oldMem_id==MemberVO.member_id)?'background-color: aliceblue;':''}">
							...
							<td class="cell100 column4"><img src=DBGifReader4.do?photo_type=license&member_id=${MemberVO.member_id} id="preview_progressbarTW_img" width=100px height=100px;/></td>
							<td class="cell100 column4">${member_status[MemberVO.member_status]}</td>
							<td class="cell100 column4">${CHIEFAPPLY_STATUS[MemberVO.chiefapply_status]}</td>
							
							
			
							
							<td class="cell100 column4"><a                                    
								href="member.do?member_id=${MemberVO.member_id}&action=getOneMemberChiefapplyStatus&whichPage=<%=whichPage%>"><button
						...
						<div class="modal-content" >
							...
							<div class="modal-body">
								<!-- =========================================以下為原listOneEmp.jsp的內容========================================== -->
 								<jsp:include page="listOneCS.jsp" /> 
