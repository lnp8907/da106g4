...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/frontEnd.css">
<link rel="stylesheet"
...
<script type="text/javascript"
	src="../../css/slick-1.8.1/slick/slick.js"></script>
...
<body bgcolor='white'>
			...
			<div class="function-list">
				...
				<div class="login">
					<a href="#"><img class="header-icon"
						src="<%=request.getContextPath()%>/image/user-icon.png"
						alt="login-icon">
				...
				<div class="notice">
					<a href="#"><img class="header-icon"
						src="<%=request.getContextPath()%>/image/ico_notice.png"
						alt="notice-icon">
						<div class="herder-icon-span">
		...
		<nav id="navigation">
			<ul>
				<li class="dropdown"><a><img class="access-menu-icon"
						src="<%=request.getContextPath()%>/image/recipe-icon.png"><span
						class="menu-span">食譜專區</span></a>

					<ul>
						<li><a class="dropdown-first-a" href="#"><img
								class="dropdown-first-img"
								src="<%=request.getContextPath()%>/image/ico_gnav_recipes_book.svg"><span
				...
				<li class="dropdown"><a><img class="access-menu-icon"
						src="<%=request.getContextPath()%>/image/livestream-icon.png"><span
				...
				<li class="dropdown dropdown-shop"><a><img
						class="access-menu-icon"
						src="<%=request.getContextPath()%>/image/shop-icon.png"><span
				...
				<li class="dropdown"><a><img class="access-menu-icon"
						src="<%=request.getContextPath()%>/image/course-icon.png"><span
						class="menu-span">料理課程</span></a>
					<ul>
						<li><a class="dropdown-first-a" href="#"><img
								class="dropdown-first-img"
								src="<%=request.getContextPath()%>/image/ico_gnav_recipes_pot.svg"><span
	...
	<div id="ShopPathLocation">
		...
		<div class="ui breadcrumb">
			...
			<a class="section"
				href="ProductPage?product_type=${productvo.product_type}&action=goProductPage">${productvo.product_type}
			</a> <i class="right angle icon divider"></i>
			<div class="active section">${productvo.product_name}</div>
		</div>
	</div>

	<div id="ShopLsearch">
		<div class="ui icon input">
			<input type="text" placeholder="你想找甚麼..."> <i
	...
	<div id="shopProduct">
		...
		<div id="Productcontext">
			<div id="productpicture">
				...
				<img
					src="../../back-end/shop_product/Product_photoReader?product_id=${productvo.product_id}
			"
					alt="">
			...
			<div id="productdescript">
				...
				<div id="descript2">
					<p>價格</p>${productvo.product_price}</div>
				<!-- 購物車 -->
				...
				<div id="descript3">
					...
					<div id="carbtnp">
						<div class="ui focus  input">
							<button id="decmun" class="ui  button red">
								<i class="minus icon "></i>
							</button>

							<input type="text" class="ui input" id="countmun" value="1">
							<button id="plusmun" class="ui  button red">
								<i class="plus icon"></i>
							</button>
	...
	<footer>
		<div class="footer-bg">
			<div class="footer-murmur">
				<img
					src="<%=request.getContextPath()%>/image/FoodPron_Logo_white.png"
					alt="logo" data-aos="zoom-in">
				<ul>
	...
	<div id="buymessage" style="border-color: #e4002b" title="購買確認">
		...
		<div>是否前往購物車查看:</div>
		<div>
			<button class="ui cancelshopcart button">
				<i class="shopping red arrow alternate circle left
 icon"></i> 繼續購物
			</button>
			...
			<button class="ui  button">
				<a
					href="<%=request.getContextPath()%>/front-end/ShopPage/ProductPage?action=checktpage1">前往購物車
				</a> <i class="shopping cart red
 icon"></i>
			</button>
		</div>
