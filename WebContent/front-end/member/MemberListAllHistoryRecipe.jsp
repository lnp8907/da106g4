...
<%@ page import="com.recipe_browsing_history.model.*"%>
...
Recipe_browing_historyService recipebrowinghistoryService = new Recipe_browing_historyService();

List<Recipe_browing_historyVO> list2 = recipebrowinghistoryService.findFollowingByPrimaryKey(member_id);
...
<!-- 					alt=""> -->
				...
				<img
					src="${(recipeSvc.getOneRecipe(Recipe_browing_historyVO.recipe_id).recipe_photo==null)?'../../image/icon/uploadPic.png':recipeSvc.getOneRecipe(Recipe_browing_historyVO.recipe_id).recipe_photo}"
					alt="">
					...
					<div class="recipe-item-caption">
						...
						<p class="recipe-create-time">食譜類型:${recipeSvc.getOneRecipe(Recipe_browing_historyVO.recipe_id).recipe_type}</p>
						<p class="recipe-item-ingredient">調理時間：${recipeSvc.getOneRecipe(Recipe_browing_historyVO.recipe_id).cook_time}</p>
