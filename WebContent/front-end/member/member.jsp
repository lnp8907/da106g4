...
<!--               </li> -->
  ...
  class="arrow fa fa-angle-right pull-right"></i></a>
  <ul>
  <li><a href="<%=request.getContextPath()+"/front-end/course/listAllCourseManagement.jsp"%>">課程管理</a>
  </li>
  <li><a href="map-vector.html">直播管理</a>
  </li>
  </ul>
  </li>

  <li class="sub-menu">
  <a href="<%=request.getContextPath()+"/front-end/recipe/listAllRecipeManagement.jsp"%>"><i class="fa fa-file"></i><img class="access-menu-icon1"
