...
#member-center-header, #member-center-header:before,
...
<body>
	...
	<aside class="sidebar">
		...
		<div id="leftside-navigation" class="nano">
			<ul class="nano-content">
				<li><a href="index.html"><i class="fa fa-dashboard"></i><img
						class="access-menu-icon1" src="image/S__12066824.jpg"><span>我的帳戶</span></a>
				</li>
				...
				<li class="sub-menu"><a href="javascript:void(0);"><i
						...
						src="image/S__12066821.jpg"><span>我的錢包/點數&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>
				...
				<li class="sub-menu"><a href="typography.html"><i
						...
						src="image/S__12066825.jpg"><span>帳號設定</span></a></li>
			</ul>
		</div>
	...
	<div class="footer-copyright24">
		...
		<footer>
			...
			<div class="footer-copyright">Copyright &copy; DA106-G4
				Foodporn All rights reserved.</div>
		...
		<script>
			$("#leftside-navigation .sub-menu > a").click(
					function(e) {
						$("#leftside-navigation ul ul").slideUp(), $(this)
								.next().is(":visible")
								|| $(this).next().slideDown(), e
								.stopPropagation()
					})
		...
		<script>
			...
			/* 直播專區 right scale 效果 */
			$(".article-section-description-livestream-right").hover(
					function() {
