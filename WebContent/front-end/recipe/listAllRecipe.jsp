...
.result-align div button {
	border: 0;
	font-weight: 600;
	font-size: 14px;
}

.result-align div button:hover {
		...
		<div class="result-align">
			...
			<div>
				<form method="post" action="RecipeServlet">
					...
					<input type="hidden" name="sort_type" value="cook_time"> <input
						name="selectedType" value="${selectedType}" type="hidden">
					<input name="selectedValue" value="${selectedValue}" type="hidden">
					<input name="keyword" value="${keyword}" type="hidden">
				</form>
			</div>
