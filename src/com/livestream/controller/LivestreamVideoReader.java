...
@WebServlet({ "/front-end/livestream/LivestreamVideoReader","/LivestreamVideoReader" })
public class LivestreamVideoReader extends HttpServlet {
///
	Connection con;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
				"SELECT video FROM livestream WHERE livestream_id = " + livestream_id);  //+ req.getParameter("PID")
			if (rs.next()) {
