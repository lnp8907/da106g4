package com.donation_record.controller;
...
import com.donation_record.model.Donation_RecordVO;
import com.donation_record.model.DrService;

public class DonationRecordServlet extends HttpServlet{
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/donation/select_page_donation.jsp");
				...
				String url = "/donation/listOneDonation.jsp";
