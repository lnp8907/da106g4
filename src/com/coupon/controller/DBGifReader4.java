...
String c_no = req.getParameter("c_no").trim();
			ResultSet rs = stmt.executeQuery(
"SELECT C_PICTURE FROM COUPON WHERE C_NO = '"+ c_no +"'");

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("C_PICTURE"));
